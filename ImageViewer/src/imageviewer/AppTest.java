...
public class AppTest extends Canvas 
{
        ...
        public AppTest(final Composite parent) 
        {
         ...
         */
        public AppTest(final Composite parent, int style) {
        ...
        /**
         * Call back funtion of button "open". Will open a file dialog, and choose the image file. It
         * supports image formats supported by Eclipse.
         */
